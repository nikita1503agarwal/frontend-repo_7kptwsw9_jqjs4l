      ...
      <div className="relative overflow-hidden rounded-3xl border border-white/10 bg-gradient-to-br from-indigo-600/20 via-purple-600/20 to-amber-400/10 p-8 backdrop-blur-xl shadow-2xl">
        ...
        <div className="relative grid grid-cols-1 items-center gap-6 md:grid-cols-5">
          <div className="md:col-span-3">
            <h3 className="text-2xl md:text-3xl font-bold text-white">Siap menerangi jalur Anda?</h3>
            <p className="mt-2 text-indigo-100/80">Jalankan pemindaian AI penuh untuk memetakan kekuatan, menyelaraskan keterampilan, dan menerima rute pertumbuhan personal yang presisi.</p>
          </div>
